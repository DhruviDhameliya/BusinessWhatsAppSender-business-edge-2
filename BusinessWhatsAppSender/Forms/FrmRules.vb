Public Class FrmRules
    ...
    Private Sub ButtonOK_Click(sender As Object, e As EventArgs) Handles ButtonOK.Click
        ...
        If TextBoxKeyword.Text = "" Then
            TextBoxKeyword.Focus()
            Exit Sub
        End If

        Dim _autoReplyObject As New ClsRuleModel
        _autoReplyObject.RuleMessage = TextBoxMessage.Text
        _autoReplyObject.RuleKeyword = TextBoxKeyword.Text
    ...
    Private Sub FrmAutoReply_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        If Not IsNothing(Rule) Then
            Try
                ...
                TextBoxRuleName.Text = Rule.RuleName
                ComboBox1.Text = Rule.Operand
