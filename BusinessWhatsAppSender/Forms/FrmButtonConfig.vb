...
Public Class FrmButtonConfig
    ...
    Private Sub SaveFormData()
        ...
        File.WriteAllText(ClsSpecialDirectories.ButtonsFolder & "buttonData.json", json)
    End Sub
    ...
    Private Sub SaveListBtnData()
        ...
        Dim json As String = JsonConvert.SerializeObject(rootObject, Formatting.Indented)
        File.WriteAllText(ClsSpecialDirectories.ButtonsFolder & "buttonListData.json", json)
    End Sub

    Private Sub LoadListBtnData()
        If File.Exists(ClsSpecialDirectories.ButtonsFolder & "buttonListData.json") Then
            Dim json As String = File.ReadAllText(ClsSpecialDirectories.ButtonsFolder & "buttonListData.json")
            Dim myObject As LabelRootObject = JsonConvert.DeserializeObject(Of LabelRootObject)(json)
